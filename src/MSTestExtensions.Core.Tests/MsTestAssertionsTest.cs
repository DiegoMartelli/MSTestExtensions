...
namespace MSTestExtensions.Tests
{
    ...
    public class MsTestAssertionsTest : BaseTest
    {
        ...
        public void TestMethodAreEqualString()
        {
            ...
            {
                Console.WriteLine(e.Message);
                Assert.AreEqual("Assert.AreEqual failed. Expected:<Hello>. Actual:<hello>. ", e.Message);
            }
        }
        ...
        public void TestMethodAreEqualStringMessage()
        {
            ...
            {
                Console.WriteLine(e.Message);
                Assert.AreEqual("Assert.AreEqual failed. Expected:<Hello>. Actual:<hello>. Strings are not equal", e.Message);
            }
        }
        ...
        public void TestMethodAreEqualStringMessageFormat()
        {
            try
            {
                Assert.AreEqual("Hello", "hello", false, "{0} and {1} strings are not equal", "Hello", "hello");
            }
            catch (Exception e)
            {
                Console.WriteLine(e.Message);
                Assert.AreEqual("Assert.AreEqual failed. Expected:<Hello>. Actual:<hello>. Hello and hello strings are not equal", e.Message);
            }
